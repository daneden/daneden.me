...
function Metatags(props: MetatagsProps): ReactElement<typeof Head> {
  ...
  return (
    <Head>
      ...
      {/* Fonts */}
      <link
        href="https://fonts.googleapis.com/css2?family=Overpass:ital,wght@0,400;0,600;0,700;1,400;1,600;1,700&family=IBM+Plex+Mono:ital,wght@0,400;0,700;1,400;1,700&display=swap"
        rel="stylesheet"
      />
