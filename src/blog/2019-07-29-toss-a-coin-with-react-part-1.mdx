...
<Note>
  ...
  <Link to="/2019/08/10/toss-a-coin-with-react-part-2/">part two</Link> and{' '}
  <Link to="/2020/02/03/toss-a-coin-with-react-part-3/">part three</Link> when
  you’re done here!
</Note>
...
The line highlighted above could also be written like this:
