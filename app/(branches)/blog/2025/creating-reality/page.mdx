...
Are you familiar with the game “telephone”? You might know it by a different
name. The first person whispers something into the second person’s ear; the
second person whispers what they heard into the third person’s ear, and it
carries on in this manner until you get to the end.

Hold that game in your thoughts; we’ll come back to it. For now, I want to talk
...
“expressive” than what came before. Generally what’s meant by this is that we
...
experiences you may use daily. And compared to what came before it, it’s very
expressive.
...
Let’s take another example. Written communication is both highly expressive and
...
not enough to make sure an idea is shared consistently. Wouldn’t it be easier if
you got to see a picture along with the phrase?

I wanted to share these examples to illustrate the point that design doesn’t
just happen in design tools. It happens in conversations, writing,
and—critically—it happens in code.
...
It’s like asking: _Should Designers Write? Speak? Gesture? Prototype? Wireframe?
**Design?**_
...
Design, in my mind, is the expression of an idea. It’s the exercise of getting
an idea out of your mind and into the minds of others, through whatever tool we
find most useful. It’s about creating a shared reality.
...
want to make sure our intent is adequately expressed in code. So let’s get to
know who we’re working with.
...
only in the simplest terms: 0’s and 1’s. Over the years, as technology has
advanced, we’ve been able to build more sophisticated abstractions which allow
...
I have a feeling that this is why so many designers not only don’t exercise
...
between our idea and the computer’s reality concrete and specific...
...
There’s a whole other language of experience design that design tools can’t
...
our work. It lets us add enhancements for technologies like VoiceOver. We’re
...
That’s not a typo—it's the same list. This list comes from the
[National Academy of Engineers](https://www.raeng.org.uk/media/brjjknt3/thinking-like-an-engineer-full-report.pdf);
it’s their list of 6 habits of mind that every engineer adopts.
...
appear to speak a different language, but our goals—and even our approaches—are
