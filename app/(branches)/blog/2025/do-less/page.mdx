...
[Ora](https://ora.daneden.me), to the App Store. Ora is a funny project, since
it took me over a year to get it into a shippable state—but for most of that
time, I didn’t touch the codebase at all. I stopped working on it in June of
2024, and when I opened it again in January of 2025, I spent most of my time
**removing** features from the app.
