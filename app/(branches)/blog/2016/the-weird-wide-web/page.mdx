...
<Image
    ...
    height={482}
    src="/uploads/2016/08/www.png"
    width={870}
/>

From my “hotel desk” in Meta’s New York office, I can see a handful of different
environments. A cluster of soft chairs for people to sit & work situated on a
grass-green carpet; a kitchen with chipboard walls and dozens of coffee
samovars, empty for the third time in two hours; and a forest of white pillars
bordering the desk space for this floor’s employees. But right by the elevators,
two of these columns are garishly different—painted from floor to ceiling in a
[Love Hearts](http://www.lovehearts.com/)-inspired gradient of pastel colors,
with interjections of clashing spray-paint scribbles.
...
<Image
    alt="The interior of the Meta New York office"
    caption="Pillars in the Meta New York office echo a recent trend in web design"
    height={1512}
    src="/uploads/2016/08/fbny.jpg"
    width={2016}
/>
