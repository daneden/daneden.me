import DrawingWithNumbersSketch from "./DrawingWithNumbersSketch"
...
<Image
    ...
    height={2048}
    src="/uploads/2017/01/diff-growth.png"
    width={2048}
/>
...
<Image
    ...
    height={6000}
    src="/uploads/2016/11/dwn-serra.jpg"
    width={4000}
/>
...
from Fred Sandback. One collection that stuck with me is the work of Sol LeWitt.
One piece features thousands, perhaps millions, of hand-drawn lines, in a
variety of patterns. The cumulative effect of line after line creates an array
of sometimes wildly different visualizations.
...
<Image
    ...
    height={4000}
    src="/uploads/2016/11/dwn-sollewitt.jpg"
    width={6000}
/>
...
<Image
    ...
    height={1826}
    src="/uploads/2016/11/dwn-dropbox.jpg"
    width={1218}
/>
...
<Image
    ...
    caption={
        <>
            One example of the kinds of sketches that would collapse on p5.js
            and demanded a more powerful medium. “Fabric,”{" "}
            <Link href="/uploads/2016/11/dwn-fabric.png">full size</Link>.
        </>
    }
    height={2000}
    src="/uploads/2016/11/dwn-fabric.png"
    width={2000}
/>
...
<Image
    ...
    caption={
        <>
            “Moons” series, expressing a single algorithm in several different
            ways. <Link href="/uploads/2016/11/dwn-moons.png">Full size</Link>.
        </>
    }
    height={3200}
    src="/uploads/2016/11/dwn-moons.png"
    width={3200}
/>
<Image
    ...
    caption={
        <>
            Complexity borne out of simplicity. Fill a circle with dashes of
            random length, ensuring none of them overlap. “Dashes,”{" "}
            <Link href="/uploads/2016/11/dwn-dashes.png">full size</Link>.
        </>
    }
    height={2000}
    src="/uploads/2016/11/dwn-dashes.png"
    width={2000}
/>
<Image
    ...
    caption={
        <>
            “Sandlines,” inspired by Anders Hoff’s{" "}
            <Link href="http://inconvergent.net/generative/sand-spline/">
                Sand Spline
            </Link>
            . <Link href="/uploads/2016/11/dwn-sandlines.png">Full size</Link>
        </>
    }
    height={2000}
    src="/uploads/2016/11/dwn-sandlines.png"
    width={2000}
/>
...
<Image
    ...
    height={5247}
    src="/uploads/2016/11/dwn-print1.jpg"
    width={3498}
/>
<Image
    alt="A printed piece of generative art"
    height={5892}
    src="/uploads/2016/11/dwn-print2.jpg"
    width={3928}
/>
<Image
    alt="A printed piece of generative art"
    height={5768}
    src="/uploads/2016/11/dwn-print3.jpg"
    width={3845}
/>
...
-   [Defne Beyce](https://defne-beyce.squarespace.com/), for her help with
    printing;
-   Meta’s [Analog Lab](https://twitter.com/analoglab) staff for allowing me to
    hang out, use the equipment, and ask dumb questions.
