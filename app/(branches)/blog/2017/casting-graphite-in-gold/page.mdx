export const metadata = {
    ...
    openGraph: {
        ...
        images: [
            {
                url: "/og/casting-graphite-in-gold",
            },
        ],
    },
}
...
<Image
    alt="Three circles and three squares intersect each other, progressively becoming more visually rich and interesting. The shapes on the left are outlined; the shapes in the middle are black-and-white; the shapes on the right are in vibrant yellow and red."
    height={780}
    src="/uploads/2017/06/graphite.png"
    width={2000}
/>
