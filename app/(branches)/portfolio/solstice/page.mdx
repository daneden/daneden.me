...
<Review stars={5} title="Love it">
    It’s a simple idea extremely well executed, beautifully designed, love the
    watch complications, useful app which brings joy. Thanks!
</Review>

<Review stars={5} title="The perfect app">
    Simple, functional, reliable. Does what it claims to do quietly and with no
    fuss. Perfection.
</Review>

<Review stars={5} title="Perfect lightweight utility">
    I’m a big fan of Solstice for its clean, simple design and helpful at a
    glance data. The widgets are perfect for being able to glance at sunrise and
    sunset times, and I enjoy being able to look into the future at different
    dates to see the amount of sunlight for that day.
</Review>

<Review stars={5} title="poetic">
    few apps touch the twin spirit of poetry and technology. this is a rare
    example. thank you, daniel.
</Review>

<Review stars={5} title="Cute utility!">
    Finally downloaded this after winter started and it’s such a neat little
    app. I was really excited to use the widget and it’s a fun way to pass the
    dreary winter
</Review>

<Review stars={5} title="Wonderful design">
    Writing this passing through roads above the arctic circle where the sun
    hasn’t rose for 5 days. Started appreciating effects of sunlight on my
    health. Thanks!
</Review>
