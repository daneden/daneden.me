...
{% figure 2017/07/fig-1-1.png "The structural elements of an atomic design system: Concept, Pattern, Component, and Atom." %}
...
{% figure 2017/07/fig-1-4.png "The three domains/layers of the system: Conceptual (Essence), Pattern (Execution), and Visual (Expression)" %}
