...
date: "2017-07-17"
excerpt: >
    How do we draw the lines between a 'pattern' and a 'component' in design
    systems? How do systems intersect with brand design? In this post, we
    outline a structure that can be applied to a design system to identify its
