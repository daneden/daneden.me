    ...
    <div className="root">
      <div className="intro spanall">
        <p className="xxl">
          ...
          <Link href="https://meta.com/" legacyBehavior>Meta</Link> in London, working on
          making Customer Support experiences that are more equitable, human,
          and helpful. He spends his time <Link href="/blog" legacyBehavior>writing</Link>,
          thinking, <Link href="https://twitter.com/_dte" legacyBehavior>tweeting</Link>, and
      ...
      <div className="tile where-we-can-go">
        ...
        <p>
          A <Link href="" legacyBehavior>conference talk</Link> and{" "}
          <Link href="/blog/2019/where-we-can-go" legacyBehavior>essay</Link> about design
      ...
      <div className="tile extras xxl">
        <Link href="/blog" legacyBehavior>Writing &rarr;</Link>
        <Link href="/portfolio" legacyBehavior>Projects &rarr;</Link>
        <Link href="/playlist" legacyBehavior>Playlist &rarr;</Link>
      </div>
