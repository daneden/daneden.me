/*
 ...
 MyFonts Webfont Build ID 3027330, 2015-05-18T00:14:57-0400
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=3027330
 Licensed pageviews: 250,000
 Webfonts copyright: Copyright &#x00A9; 2015 Monotype Imaging Inc.  All rights reserved.

 ? 2015 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2e3182";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0,woff2Enabled=1;
...
for(var fonts=[{fontFamily:"NeueHaasUnica",fontWeight:"bold",fontStyle:"normal",url:wfpath+"2E3182_0"+suffix+"_0."+webfontType},{fontFamily:"NeueHaasUnica",fontWeight:"bold",fontStyle:"italic",url:wfpath+"2E3182_1"+suffix+"_0."+webfontType},{fontFamily:"NeueHaasUnica",fontWeight:"normal",fontStyle:"italic",url:wfpath+"2E3182_2"+suffix+"_0."+webfontType},{fontFamily:"NeueHaasUnica",fontWeight:"normal",fontStyle:"normal",url:wfpath+"2E3182_3"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<
